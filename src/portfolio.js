...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1UAe3yze6uZY0xFinCD4ze3jcat1gOY5O/view?usp=sharing"
};
...
const workExperiences = {
  ...
  experience: [
    ...
    {
      role: "Software Engineer",
      company: "Full Health Medical, london, United kingdom",
      companylogo: require("./assets/images/fullhealthlogo.jpeg"),
      date: "May/2022 - Present",
      descBullets: [
        "Analyzed and improved or maintaining application efficiency by optimizing queries, and code refactoring in existing applications.",
        ...
        "Coordinate with team members who work on different layers of infrastructure and review and debug junior developers code."
      ]
    }
  ]
};
...
const contactInfo = {
  ...
  subtitle: "Would like to discuss a project or just say hello? My inbox is open to all.",
